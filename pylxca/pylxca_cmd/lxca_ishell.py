...
class InteractiveShell(object):
    ...
    class help(InteractiveCommand):
        ...
        def handle_command(self, opts, args):
            ...
            if args[0] not in self.commands:
                self.sprint(
                    'No help available for unknown command "%s"' %
                    args[0])
                return
        ...
        def do_command_summary(self):
            ...
            for name in sorted(self.commands.keys()):
                ...
                try:
                    ...
                    # For some commands there is no short desc so it will be
                    # skipped
                    continue
    ...
    # TODO: We should remove this, All API level code should give call to
    # handle_input_dict rather
